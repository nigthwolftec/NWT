	...
	<div id="agrupar">
		...
		<section id="seccion">
			<form id="form1" name="form1" method="post" action="">
				...
				<table>
					<tr>
					<p class="Centro"><h3>MODIFICACION EXITOSA</h3></p>
					</tr>
                </table>
                <?php
                include "modificarCli.php";
                $mod= new ModificarCli();
                $mod-> inicializarBD($_REQUEST['nuevo'],$_REQUEST['viejo']);
                $mod-> conectarBD();
                $mod-> modificarUsuario();
				$mod->cerrarBD();		
