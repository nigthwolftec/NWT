...
class Usuario{
    private $idusuarios;
    public function inicializarBD($idusuarios){
...
public function consultarUsuario($idusuarios){
    $registro=mysqli_query($this->conectarBD(),"select * from usuarios where idusuarios=$this->idusuarios") or die(mysqli_error($this->conectarBD()));
