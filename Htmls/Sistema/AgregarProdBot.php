...
<body>
	<div id="agrupar">
		...
		<section id="seccion">
			<form id="form1" name="form1" method="post" action="agregarProdCtrlBOTANAS.php" enctype="multipart/form-data">
				<p  class="centro"><h3>Agregar productos</h3></p>
				<br>
				<table>
					<tr>
						<td>NOMBRE DEL PRODUCTO</td>
						<td><input type="text" name="nombot"/></td>
					</tr>
					<tr>
						<td>PRECIO</td>
						<td><input type="text" name="preciobot"/></td>
					</tr>					
					<tr>
						<td>IMAGEN</td>
