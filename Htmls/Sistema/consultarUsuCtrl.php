...
<body>
	<div id="agrupar">
		...
		<section id="seccion">
			<form id="form1" name="form1" method="post" action="consultarUsuario.php">
				<p class="Centro"><h3>DATOS DEL EMPLEADO</h3></p>
				<br>
				<?php
                include "consultarUsu.php";
                $cc = new Usuario();
                $cc-> inicializarBD($_REQUEST['buscar']);
                $cc-> conectarBD();
                $cc-> consultarUsuario($_REQUEST['buscar']);
                $cc-> cerrarBD();
            ?>
				<br>
				<br>
