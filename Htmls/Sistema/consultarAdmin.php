...
<body>
	<div id="agrupar">
		...
		<section id="seccion">
			<form id="form1" name="form1" method="post" action="consultaAdmin.php">
				<p class="Centro"><h3>DATOS DEL EMPLEADO</h3></p>
				<br>
				<?php
                include "consultarAdmi.php";
                $cons= new Consulta();
                $cons-> inicializarBD($_REQUEST['buscar']);
                $cons-> conectarBD();
                $cons-> consultarAdmi($_REQUEST['buscar']);
                $cons-> cerrarBD();
            ?>
				<br>
				<br>
