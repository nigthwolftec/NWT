...
<body>
	<div id="agrupar">
		...
		<section id="seccion">
			<form id="form1" name="form1" method="post" action="Alterclie.php">
				<p class="Centro"><h3>Alterar Empleados</h3></p>
				<br>
				<table>
						<tr>
							<td>Viejo Email:<br></td>
							<td><input type="search" name="viejo"></td>
	
						</tr>
						<tr>
							<td>Nuevo Email:<br></td>
							<td><input type="search" name="nuevo"></td>
						</tr>
					</table>
					<br>
