...
<body>
	<div id="agrupar">
		...
		<section id="seccion">
				<p  class="centro"><h3>Modificar productos</h3></p>
                <?php
	include "Prod.php";
	$fot= new Foto();
	$fot-> conectarBD();
	$fot-> modifica($_REQUEST["precionue"],$_REQUEST["Nombnue"],$_REQUEST["codvie"],$_FILES["foto"]["name"],$_FILES["foto"]["tmp_name"],$_REQUEST["observaciones"]);
	$fot-> cerrarBD();
?>			
				<br>
				<br>
